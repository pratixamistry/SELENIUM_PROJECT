...
//		//Option 1
		...
		//Scrolling down the page till the element is found
		 WebElement Element = driver.findElement(By.id("windowButton"));		//windowButton => id of button which needs to be clicked
...
////				Thread.sleep(2000);
				WebElement web_text = driver.findElement(By.id("sampleHeading"));
